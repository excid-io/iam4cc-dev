...
headers = {
     "Authorization": "Basic " + base64.b64encode(json.dumps(vp).encode()).decode(),
...
response = requests.post( "http://localhost:6002/api/decide/MakeDecision", data=json.dumps(auth_request), headers=headers)
print(response.text)